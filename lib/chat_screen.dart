...
class ChatScreen extends StatelessWidget {
                      ...
                      children: [
                        ...
                        TextButton(
                          child: const Text(
                            "مسح",
                            style: TextStyle(
                              color: Color(0xFFEF5350), // نفس اللون الأحمر القديم
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                          onPressed: () async {
                            ...
                            Get.rawSnackbar(
                              ...
                              backgroundColor: const Color(0xFFEF5350), // نفس لون المسح
    ...
    return Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    chatState.replyToMessage.value!['text']!.length >
                        60
  ...
  GestureDetector messagesDesign(bool isUser, ChatController chatState, Map<String, String> msg, int i) {
